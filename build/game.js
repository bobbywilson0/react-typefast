...
var Game = React.createClass({displayName: 'Game',
  ...
  render: function() {
    ...
    var renderWord = function(word, index) {
      return Word({key: index, index: index, cssClass: self.highlightWord(index)}, word)
    }
    ...
    return(
      React.DOM.div(null, 
        ...
        React.DOM.input({type: "text", ref: "textInput", value: self.state.userInput, onChange: self.handleChange})
      )
    )
  }
});
